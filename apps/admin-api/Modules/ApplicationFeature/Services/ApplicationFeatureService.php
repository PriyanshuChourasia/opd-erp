...
namespace Modules\ApplicationFeature\Services;
...
class ApplicationFeatureService implements ApplicationFeatureServiceInterface
{
    private string $table = 'application_features';
