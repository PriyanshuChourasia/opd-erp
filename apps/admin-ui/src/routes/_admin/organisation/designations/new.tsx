...
import { useCreateDesignation } from "@/features/designations/hooks";
import { designationFormSchema } from "@/features/designations/schema";

export const Route = createFileRoute("/_admin/organisation/designations/new")({
  component: NewDesignationPage,
});

function NewDesignationPage() {
  ...
  return (
    <EntityFormPage
      ...
      description="Job titles scoped to a department."
